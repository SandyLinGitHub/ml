##
##
##  ResNet18 model using TF dataloader runs fine. 
##  Added in some script to help profile the performances of the training
##
##
import os
...
main_path = os.path.join(current_directory, 'Git_ml/train')
print(main_path)
...
log_dir = "18_TF_logs/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
log_file = "session_log_18_TF.txt"
